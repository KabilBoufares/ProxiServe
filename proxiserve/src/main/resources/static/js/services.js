document.addEventListener("DOMContentLoaded", () => {
    ...
    async function fetchServices() {
      ...
      try {
        ...
        const data = await res.json();
        renderServices(data);
        renderPagination(data.length); // pagination basée sur la taille réelle
      } catch (e) {
        ...
        <div class="service-card">
          ...
          <div class="service-info">
            ...
            <div class="service-contact">
              ...
              <button class="contact-btn secondary-btn" onclick="window.location.href='/artisan/${service.artisanId}'">Voir Profil</button>
            </div>
          </div>
        </div>
      `).join('');
        ...
        navigator.geolocation.getCurrentPosition(
          async (pos) => {
            ...
            try {
              ...
              //  on déclenche manuellement la mise à jour
